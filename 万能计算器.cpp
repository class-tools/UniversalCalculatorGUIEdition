...
int main()
{
	cout << "万能计算器" << endl;
	cout << "使用说明：" << endl;
	cout << "1、加、减、乘、除、乘方、杨辉三角求项、排列数计算和组合数计算：输入第一个数、符号和第二个数，按Enter键输出结果。" << endl;
	cout << "2、开平方、判断质数、杨辉三角整行求和和奇数阶幻方：输入第一个数和符号，按Enter键输出结果。" << endl;
	cout << "3、最大公因数和最小公倍数：输入第一个数、符号，接着连着输入一些数，按Enter键输出结果。" << endl;
	cout << "4、鸡兔同笼：输入第一个数、符号、第二个数、第三个数和第四个数，按Enter键输出结果。" << endl;
	cout << "5、每种功能具体输入内容如下所示：" << endl;
	cout << "加法：加数、+和另一个加数；" << endl;
	cout << "减法：被减数、-和减数；" << endl;
	cout << "乘法：因数、*和另一个因数；" << endl;
	cout << "除法：被除数、/和除数；" << endl;
	cout << "乘方：底数、d和指数；" << endl;
	cout << "杨辉三角求项：行、e和列；" << endl;
	cout << "排列数计算：下角标、a和上角标；" << endl;
	cout << "组合数计算：下角标、c和上角标；" << endl;
	cout << "开平方：被开方数和g；" << endl;
	cout << "判断质数：被判断数和p；" << endl;
	cout << "杨辉三角整行求和：行数和b；" << endl;
	cout << "奇数阶幻方：阶数和h；" << endl;
	cout << "最大公因数：数的个数、小括号（英文）和n（数的个数）个求最大公因数的数；" << endl;
	cout << "最小公倍数：数的个数、中括号（英文）和n（数的个数）个求最小公倍数的数；" << endl;
	cout << "鸡兔同笼：头数、f、脚数、鸡脚数和兔脚数（鸡脚数≤兔脚数）；" << endl;
	cout << "6、注意事项：每输入完一个数就输入一个空格，输入完符号后换一行再输入。" << endl;
	cout << "7、建议在英文输入法下使用。" << endl;
	while(1)
	{
		cin >> b >> d;
		if(d!='g'&&d!='G'//开平方。
